                    ...
                    <div class="serch-form">
                         <form action="<?php echo base_url();?>ad/search" method="get">
                            <div class="form-row">
                                <div class="col">
                                    <div class="serchable">
                                        <input type="text" name="category" class="search-categorie" placeholder="search item" list="category_list" value="<?=$this->input->get('category');?>">
                                    ...
                                    <div class="distance">
                                        <select class="custom-select distance-field" name="radius">
                                            ...
                                            <option value="5"<?php if($this->input->get('radius')==5)?>>+ 5 km</option>
                                            <option value="10"<?php if($this->input->get('radius')==10)?>>+ 10 km</option>
                                            <option value="15"<?php if($this->input->get('radius')==15)?>>+ 15 km</option>
                                            <option value="20"<?php if($this->input->get('radius')==20)?>>+ 20 km</option>
                                            <option value="30"<?php if($this->input->get('radius')==30)?>>+ 30 km</option>
                                            <option value="50"<?php if($this->input->get('radius')==50)?>>+ 50 km</option>
                                            <option value="100"<?php if($this->input->get('radius')==100)?>>+ 100 km</option>
                                            <option value="1000"<?php if($this->input->get('radius')==1000)?>>+ All</option>
                                        </select>
                                    </div>
                                    <div class="find">
                    ...
                    <div class="anchor-tags">
                        <div class="container">
                            <div class="row">
                                ...
                                $sub_qry=$this->db->get('subcategory_master',5)->result_array();
                                ...
                                <ul class="sidebar-list">
                                    ...
                                    <li class="sidebar-anchor"><a href="<?php echo base_url();?>ad/category/<?=strtolower(str_replace(" ", "_",$category['category_name']));?>"><?=$category['category_name']?></a>
                                     <ul class="sidebar-under-list">
                                        ...
                                        {                     
                                        ?>
                                        <a href="<?php echo base_url();?>ad/subcategory/<?=$sub['id']?>"><li><span><?=$sub['subcategory_name']?></span></li></a>
                                        <?php } ?>  
                                     </ul>
                                    </li>
                ...
                <div class="col-md-4 d-none">
                    <div class="category-filter-list">
                        <div class="refine-category">
                            ...
                            <ul>
                                <a href="<?php echo base_url();?>ad/allcategory">
                                    <li>All categories</li>
                                </a>
                                <?php 
                                $this->db->select('id');
                                ...
                                {                     
                                ?>
                                <a href="<?php echo base_url();?>ad/subcategory/<?=$sub['id']?>"><li><?=$sub['subcategory_name']?></li></a>
                                <?php 
                                ...
                                ?>
                                <a href="<?php echo base_url();?>ad/childcategory/<?=$child['id']?>">
                                    <li><span><?=$child['child_sub_name']?></span></li>
                                </a>
                                <?php } } ?>
                                <?php } ?>
                        ...
                        <div class="item-list-box">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-3">
                                 <marquee class="marquee"><span><img style="width: 30px;" src="<?php echo base_url();?>style/heart.png" alt="Ads Main Image"> <img style="width: 30px;" src="<?php echo base_url();?>style/heart.png" alt="Ads Main Image">  Make your Ads Premium Or Featured To Rank To Higher and Get more Premium Customers  <img style="width: 30px;" src="<?php echo base_url();?>style/heart.png" alt="Ads Main Image"><img style="width: 30px;" src="<?php echo base_url();?>style/fire2.png" alt="Ads Main Image"></span></marquee>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="non-premium-sec mb-4">
                                        <ul>
                                            ...
                                            {
                                            ?>
                                            <li ><img class="im" style="width: 20px;" src="<?php echo base_url();?>style/heart.png" alt="Ads Main Image">  <img class="im" style="width: 20px;" src="<?php echo base_url();?>style/heart.png" alt="Ads Main Image">  <a href="<?php echo base_url();?>ad/details/<?=$ad_qry->id;?>?pagefirst==0"><?=utf8_decode($ad_qry->ad_title)?> <span> (<?=$ad_qry->country?>)</span></a> <img class="im" style="width: 20px;" src="<?php echo base_url();?>style/fire2.png" alt="Ads Main Image"><imgclass="im"  style="width: 20px;" src="<?php echo base_url();?>style/fire2.png"> <img class="im" style="width: 20px;" src="<?php echo base_url();?>style/fire2.png" alt="Ads Main Image"></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </div>
