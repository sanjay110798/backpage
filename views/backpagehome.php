                ...
                <div class="row">
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="<?php echo base_url();?>ad/category/<?=strtolower(str_replace(" ", "_",$cat['category_name']));?>">
                                <div class="practise-img mb-3">
                                    <img src="<?=$cat['category_icon']?>" alt="Category Image">
                                </div>
                            ...
                            <div class="col-12 px-md-0 px-sm-3 px-2 shadow-div">
                                <div class="carousel-box">
                                    <div class="carousel-upper">
                                        <div class="row">
                                            <div class="col-sm-6 py-sm-0 px-2"><span class="c-location"><i class="fa fa-map-marker"></i><?=substr($ad_qry->city,0,8);?>..</span></div>
                                            <div class="col-sm-6 py-sm-0 px-2"><span class="c-category float-sm-right"><i class="fa fa-list-alt" aria-hidden="true"></i> <?=$cat_qry->category_name;?></span></div>
                                        </div>
                                    </div>
                                    <div class="carousel-lower">
                                        <img src="<?=$ad_qry->ad_image;?>" alt="Carousel Image">
