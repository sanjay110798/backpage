...
<section class="banner" style="background-image: url(https://backpageclassifieds.com/style/rajarshi_images/banner-new.jpg);">
    ...
    <div class="container px-md-0">
        <div class="location-search-form-area wow fadeInUp">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <form class="location-search-form" action="#" method="post">
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-2 pr-md-0 my-md-0 my-2">
                                    ...
                                    <div class="col-md-3 my-md-0 my-2">
                                        <button type="submit" class="btn location-search-btn"><i class="fa fa-search mr-2" aria-hidden="true"></i>Click to Search</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--    practise-areas-start-->

<section class="practise-areas-wrap py-4">
    <!--    <div class="practise-overlay"></div>-->
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 px-lg-3 px-md-0 px-sm-3 px-4">
                <div class="row">
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/classes">
                                <div class="practise-img mb-3">
                                    <img src="https://crackerclassifieds.com/upload/1582783826_presentation.png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Classes</h6>
                                    <p>Backpage Classifieds</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/community">
                                <div class="practise-img mb-3">
                                    <img src="https://crackerclassifieds.com/upload/1575625913_social-care.png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Community</h6>
                                    <p>Backpage Classifieds</p>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/events">
                                <div class="practise-img mb-3"><img src="https://crackerclassifieds.com/upload/1575625939_calendar.png" alt="Category Image"></div>
                                <div class="practise-caption">
                                    <h6>Events</h6>
                                    <p>Backpage Classifieds</p>
                                </div>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/for_sale">
                                <div class="practise-img mb-3"> <img src="https://crackerclassifieds.com/upload/1582780990_coupon.png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>For Sale</h6>
                                    <p>Backpage Classifieds</p>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/jobs">
                                <div class="practise-img mb-3"> <img src="https://crackerclassifieds.com/upload/1582892693_businessman (2).png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Jobs</h6>
                                    <p>Backpage Classifieds</p>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/personals">
                                <div class="practise-img mb-3"><img src="https://crackerclassifieds.com/upload/1582892103_like (1).png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Personals</h6>
                                    <p>Backpage Classifieds</p>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/real_estate">
                                <div class="practise-img mb-3">
                                    <img src="https://crackerclassifieds.com/upload/1575625979_building.png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Real Estate</h6>
                                    <p>Backpage Classifieds</p>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 practise-border text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/services">
                                <div class="practise-img mb-3">
                                    <img src="https://crackerclassifieds.com/upload/1575625990_technical-support.png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Services</h6>
                                    <p>Backpage Classifieds</p>
                    ...
                    <div class="col-md col-sm-4 col-4 my-md-0 my-2 text-center px-1">
                        <div class="practise-area-grid">
                            <a class="under-banner" href="https://backpageclassifieds.com/ad/category/vehicles">
                                <div class="practise-img mb-3">
                                    <img src="https://crackerclassifieds.com/upload/1582890446_car (1).png" alt="Category Image">
                                </div>
                                <div class="practise-caption">
                                    <h6>Vehicles</h6>
                                    <p>Backpage Classifieds</p>
...
<style>
    ...
    ::-webkit-scrollbar-track {
        box-shadow: inset 0 0 5px #0868ff;
    }

    /* Handle */
    ::-webkit-scrollbar-thumb {
        /*    background: #00acfd;*/
        background: linear-gradient(to left bottom, #00acfd 25%, #0868ff 50%);
    }
...
*/
        border-radius: 6px;
        position: relative;
        box-shadow: 0px 10px 15px 0px #a3a3a3;
    }
...
*/
    ...
    .carousel-lower {
        ...
        top: 20px;
        margin-bottom: 30px;
        box-shadow: 0px 10px 10px 1px #a3a3a3;
    }
    ...
    .carousel-lower .watermark-wrap .watermark {
        width: 80% !important;
        height: auto;
        opacity: 0.60;
        margin: 0 auto;
    ...
    .carousel-lower .classification-wrap {
        position: absolute;
        width: 100%;
        height: 100%;
        left: 0;
    ...
    .topad-text {
        ...
        background: linear-gradient(180deg, #cd0309d6 0, #ff0006e0 50%);
        ...
        right: 5px;
        top: 5px;
        box-shadow: 1px 1px 6px 0px #00000047;
    }
    ...
    .featured-text {
        ...
        line-height: 22px;
        padding: 4px 5px;
        /* background: linear-gradient(180deg, #77c126d6 0, #93f9b9e0 100%); */
        background: linear-gradient(180deg, #4a932ed6 0, #69b21be0 100%);
        /* background: linear-gradient(180deg, #005535d6 0, #0aff65e0 50%); */
        border-top-left-radius: 15px;
        border-bottom-right-radius: 15px;
        border: 2px solid #ffffff;
        color: #ffffff;
    ...
    .country-container.carousel-country-container {
        padding: 20px 0 0 0;
    }
...
<section class="carousel-section my-lg-5 my-4">
    <div class="container">
        <div class="row">
            <div class="col-md-12 px-md-0 text-center" bis_skin_checked="1">
                <h6 class="text-section-heading">Latest Ads</h6>
            </div>
            <div class="col-12 country-container carousel-country-container px-md-4">
                <div id="owl-carousel" class="owl-carousel owl-theme">
                    <div class="item">
                        <a href="#0">
                            <div class="col-12 px-md-0 px-sm-3 px-2 shadow-div">
                                <div class="carousel-box">
                                    <div class="carousel-upper">
                                        <div class="row">
                                            <div class="col-sm-6 py-sm-0 px-2"><span class="c-location"><i class="fa fa-map-marker"></i> Delhi</span></div>
                                            <div class="col-sm-6 py-sm-0 px-2"><span class="c-category float-sm-right"><i class="fa fa-list-alt" aria-hidden="true"></i> Vehicles</span></div>
                                        </div>
                                    </div>
                                    <div class="carousel-lower">
                                        <img src="https://backpageclassifieds.com/upload/1645349346_photo_2022-02-20_00-01-16.jpg" class="carousel-img" alt="Carousel Image">
                                        <div class="watermark-wrap d-flex align-items-center">
                                            <img class="watermark" src="<?php echo base_url();?>style/rajarshi_images/logo.png" alt="watermark">
                                        </div>
                                        <div class="classification-wrap">
                                            <h4 class="topad-text">TOP AD</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 px-md-0 px-sm-3 px-2 shadow-div">
                                <div class="carousel-box">
                                    ...
                                    <div class="carousel-lower">
                                        ...
                                        <div class="classification-wrap">
                                            <h4 class="featured-text">FEATURED</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="base"><a href="https://scorts.com.au/" target="_blank">
                                ...
                                <div>
                                    ...
                                    <!--  -->
                                    <img src="<?php echo base_url();?>style/rajarshi_images/favicon.png" class="title" alt="nfs-payback">
...
<section class="countries-section pt-5 pb-lg-5 pb-4">
    <div class="container">
        <div class="row">
            <div class="col-md-12 px-md-0 text-center">
                <h6 class="text-section-heading">Please select your Countries</h6>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_1359" style="display: none;">
                            ...
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_36" style="display: none;">
                                            <div class="state-container">
                                                <h3>Algeria</h3>
                                                <ul class="city-list">
                            ...
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_34" style="display: none;">
                                            <div class="state-container">
                                                <h3>Act</h3>
                                                <ul class="city-list">
                            ...
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_32" style="display: none;">
                                            <div class="state-container">
                                                <h3>Alberta</h3>
                                                <ul class="city-list">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_33" style="display: none;">
                                            <div class="state-container">
                                                <h3>Albania</h3>
                                                <ul class="city-list">
                            ...
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_35" style="display: none;">
                                            <div class="state-container">
                                                <h3>Argentina</h3>
                                                <ul class="city-list">
                            ...
                            <div class="col-md-12">
                                <div class="country-container2">
                                    ...
                                    <div class="state-wrap">
                                        <div class="state-list" id="country_6" style="display: none;">
                                            <div class="state-container">
                                                <h3>Alabama</h3>
                                                <ul class="city-list">
