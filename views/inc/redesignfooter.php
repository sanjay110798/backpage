   <footer class="pt-0">
       <div class="footer-content">
           <div class="main-footer-sec py-lg-5 py-3" style="background-image: url(<?php echo base_url();?>style/rajarshi_images/footer-banner3.jpg);">
               <div class="container">
                   <div class="row footer-main-part pt-2">
                       <div class="col-md-3 col-sm-6 text-sm-left text-center">
                               ...
                               <ul>
                                   <li><?php if ($this->session->userdata('login_id')=='') {?>
                                       <a href="<?=base_url('authentication?loginerr==0');?>">
                                           <?php } else{?><a href="<?=base_url('myads');?>"><?php } ?>Promote your ad</a>
                                   </li>
                                   <li><?php if ($this->session->userdata('login_id')=='') {?>
                                       <a href="<?=base_url('authentication?loginerr==0');?>">
                                           <?php } else{?><a href="<?=base_url('buycredit');?>"><?php } ?>Premium Account</a>
                                   </li>
                                   <li><?php if ($this->session->userdata('login_id')=='') {?>
                                       <a href="<?=base_url('authentication?loginfirst==1');?>">
                                           <?php } else{?><a href="<?=base_url('postad');?>"><?php } ?>Advertise on CrackerClassifieds</a>
                                   </li>
                               </ul>
                           </div>
                       </div>
   ...
   <style>
       ...
       footer .main-footer-sec ul li a {
           color: #fff;
           font-size: 17px;
           display: inline-block;
           margin-bottom: 14px;
       ...
       footer .main-footer-sec ul li a:hover {
           /*           color: #bfbfbf;*/
           color: #0868ff;
       }
...
*/
       ...
       footer .main-footer-sec .social-links li a {
       ...
       footer .main-footer-sec .social-links li a:hover {
   ...
   <style type="text/css">
    ...
    padding: 40px 0;
       ...
       .but {
           ...
           background: linear-gradient(45deg, #0868ff, #00acfd, #00acfd);
