 <link href="<?php echo base_url();?>fontassets/css/privacy-policy.css" rel="stylesheet">
 <!-- ////////////// -->
        ...
        <div class="container">
            <div class="row">
                <div class="privacy-policy-content">
                    <h6 class="privacy-policy-title">Crackers Privacy Policy</h6>
                    <h4>Who we are</h4>
                    <p>Our website address is: <a href="https://crackerclassifieds.com/">https://www.crackerclassifieds.com</a></p>

                    <h4>What personal data we collect and why we collect it</h4>
                    <p>Comments When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP address and browser user agent string to help spam detection.</p>
                    ...
                    <p>Media If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>
                    <p>Contact forms Cookies If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave
                    ...
                    <h4>Analytics</h4><br>
                    <h4>Who we share your data with</h4><br>
                    ...
                    <p>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal
