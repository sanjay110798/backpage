...
<section class="category-banner" style="background-image: url(<?=$banner->image?>)!important;">
        <div class="container">
            <div class="banner-content">
                 <div class="row">
                    <div class="serch-form hide-search" id="show_search">
                                ...
                                <div class="caraousel-box">
                                    <a href="<?php echo base_url();?>ad/details/<?=$ava->id;?>?pagefirst==0">
                                        <div class="carousel-img" href="#0">
                                            <img src="<?=$ava->ad_image;?>" class="adimage" alt="Backpage Classifieds Image">
                            ...
                            <div class="item">
                                <div class="caraousel-box">
                                    <a href="<?php echo base_url();?>ad/details/<?=$ad_qry->id;?>?pagefirst==0">
                                        <div class="carousel-img" href="#0">
                                            <img src="<?=$ad_qry->ad_image;?>" class="adimage" alt="Backpage Classifieds Image">
                                            <h6 class="top-ad-text">Top Ad</h6>
                                            <h2 class="premiumfont1">backpage</h2>
                                        </div>
                                        <div class="carousel-text">
                        ...
                        <div class="premium-option">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6 my-3">
                                    <div class="property-blog-card card" style="">
                                        <div class="card-img-top">
                                            <img src="<?=$ad_qry->ad_image;?>" class="" alt="Backpage Classifieds Image">
                              ...
                              <?php } ?>
                                ...
                                <a href=""><img src="https://bestdrifting.com/public/img/ad_birite.jpg" alt="Backpage Classifieds Image" style="width: 100%;height: 100%;"></a>  
                                </div>
