        ...
        <div class="container">
         <div class="row">
                <div class="post-free-ad">
                    ...
                    <form name="form" method="post" action="<?php echo base_url();?>postad/addadditionallist/<?=$this->session->userdata('ad_id')?>" enctype="multipart/form-data">
                </div>
            ...
            <?php } if($category==11){?>
               ...
               <!--  <div class="col-md-12 mt-2">
                    ...
                    <div class="row">
                        ...
                        <input type="checkbox" name="property_feature[]" value="Alarm system">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Broadband internet available
                        <input type="checkbox" name="property_feature[]" value="Broadband internet available">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Dishwasher
                        <input type="checkbox" name="property_feature[]" value="Dishwasher">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Outdoor entertainment area
                        <input type="checkbox" name="property_feature[]" value="Outdoor entertainment area">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Solar panels
                        <input type="checkbox" name="property_feature[]" value="Solar panels">
                        <span class="checkmark"></span>
                        </label>  
                        </div>
                        <div class="col-md-6">
                         <label class="container-checkbox">Balcony
                        <input type="checkbox" name="property_feature[]" value="Balcony">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Built-in wardrobes
                        <input type="checkbox" name="property_feature[]" value="Built-in wardrobes">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Furnished
                        <input type="checkbox" name="property_feature[]" value="Furnished">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Pets considered
                        <input type="checkbox" name="property_feature[]" value="Pets considered">
                        <span class="checkmark"></span>
                        </label>
                        <label class="container-checkbox">Swimming pool (in-ground)
                        <input type="checkbox" name="property_feature[]" value="Swimming pool (in-ground)">
                        <span class="checkmark"></span>
                        </label>      
                        </div>
                    </div>
                 ...
                 <div class="ad-post-details">
                    ...
                    <div class="post-details-form">
                            ...
                            <div class="row form-btn">
                                <div class="col">
                                    <button type="submit" class="btn post-add-btn">Add Additional</button>

                                    <a href="<?php echo base_url();?>bestview?all=1"><button class="btn post-back-btn" type="button" >Skip</button></a>
                                </div>
                            </div>
