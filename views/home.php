                        ...
                        <div class="col-md-12 col-12">
                            <div class="base"><a href="https://scorts.com.au/" target="_blank">
                                    ...
                                    <div>
                                        ...
                                        <div class="slid1"></div>
                                        <div class="butd">
                                             <span class="but" style="    width: 100%; display: contents;color: #fdfdfd;font-size: 14px!important;text-shadow: -5px 5px 3px black;">Scorts it’s Australian for <a href="<?=base_url();?>escorts"> escorts. See all the Australian <a href="<?=base_url();?>escorts"> escorts on Scorts now</span>
