                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="serchable">
                                        ...
                                        <?php } ?>
                                        <?php 
                                        $this->db->select('subcategory_master');
                                        ...
                                        <?php } ?>
                                        <?php 
                                        $this->db->select('child_sub_master');
                                ...
                                <div class="col-12">
                                    <div class="non-premium-sec mb-4">
                                        <ul>
                                            ...
                                            {
                                            ?>
                                            <li ><img class="im" style="width: 20px;" src="<?php echo base_url();?>style/heart.png">  <img class="im" style="width: 20px;" src="<?php echo base_url();?>style/heart.png">  <a href="<?php echo base_url();?>ad/details/<?=$ad_qry->id;?>?pagefirst==0"><?=utf8_decode($ad_qry->ad_title)?> <span> (<?=$ad_qry->country?>)</span></a> <img class="im" style="width: 20px;" src="<?php echo base_url();?>style/fire2.png"><imgclass="im"  style="width: 20px;" src="<?php echo base_url();?>style/fire2.png"> <img class="im" style="width: 20px;" src="<?php echo base_url();?>style/fire2.png"></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </div>
